...
json_status write_json(const proto3_unittest::TestAllTypes<hpp::proto::default_traits> &msg,
...
json_status write_json(const protobuf_unittest::TestMap<hpp::proto::non_owning_traits> &msg,
                       std::string &json_buffer) {
  return hpp::proto::write_json(msg, json_buffer);
}

json_status read_json(proto2_unittest::TestWellKnownTypes<hpp::proto::default_traits> &msg,
...
json_status read_json(hpp::proto::message_value_mref &msg, std::string_view json_view,
                      hpp::proto::alloc_option_t) {
  return hpp::proto::read_json(msg, json_view);
}
