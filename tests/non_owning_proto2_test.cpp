...
using TestAllTypes = protobuf_unittest::TestAllTypes<hpp::proto::non_owning_traits>;
using TestAllExtensions = protobuf_unittest::TestAllExtensions<hpp::proto::non_owning_traits>;
using TestFieldOrderings = protobuf_unittest::TestFieldOrderings<hpp::proto::non_owning_traits>;
using TestPackedTypes = protobuf_unittest::TestPackedTypes<hpp::proto::non_owning_traits>;
using TestPackedExtensions = protobuf_unittest::TestPackedExtensions<hpp::proto::non_owning_traits>;
using TestUnpackedTypes = protobuf_unittest::TestUnpackedTypes<hpp::proto::non_owning_traits>;
using TestUnpackedExtensions = protobuf_unittest::TestUnpackedExtensions<hpp::proto::non_owning_traits>;
using TestOneof2 = protobuf_unittest::TestOneof2<hpp::proto::non_owning_traits>;
namespace TestUtil {
...
inline void SetAll(TestAllTypes *message, auto &&mr);
inline void SetOptionalFields(TestAllTypes *message);
inline void SetRepeatedFields(TestAllTypes *message);
inline void SetDefaultFields(TestAllTypes *message);
inline void SetOneofFields(TestAllTypes *message);
inline void SetAll(TestAllExtensions *message, auto &&mr);
inline void SetOneofFields(TestAllExtensions *message, auto &&mr);
inline void SetAllFieldsAndExtensions(TestFieldOrderings *message, auto &&mr);
inline void SetAll(TestPackedTypes *message, auto &&mr);
inline void SetAll(TestPackedExtensions *message, auto &&mr);
inline void SetAll(TestUnpackedTypes *message, auto &&mr);
inline void SetOneof1(TestOneof2 *message);
inline void SetOneof2(TestOneof2 *message);

// Check that all fields have the values that they should have after
// Set*Fields() is called.
inline void ExpectAllSet(const TestAllTypes &message);
inline void ExpectAllSet(const TestAllExtensions &message);
inline void ExpectAllSet(const TestPackedTypes &message);
inline void ExpectAllSet(const TestPackedExtensions &message);
inline void ExpectAllSet(const TestUnpackedTypes &message);
inline void ExpectAllSet(const TestUnpackedExtensions &message);
inline void ExpectOneofSet1(const TestOneof2 &message);
inline void ExpectOneofSet2(const TestOneof2 &message);

// Check that all fields have their default values.
inline void ExpectClear(const TestAllTypes &message);
inline void ExpectClear(const TestAllExtensions &message);
inline void ExpectOneofClear(const TestOneof2 &message);

inline void SetAll(TestAllTypes *message, auto && /*unused*/) {
...
inline void SetOptionalFields(TestAllTypes *message) {
  ...
  message->optionalgroup = TestAllTypes::OptionalGroup{.a = 117};
  message->optional_nested_message = TestAllTypes::NestedMessage{.bb = 118};
  ...
  message->optional_lazy_message = TestAllTypes::NestedMessage{.bb = 127};

  message->optional_nested_enum = TestAllTypes::NestedEnum::BAZ;
...
inline void SetRepeatedFields(TestAllTypes *message) {
  ...
  const static TestAllTypes::RepeatedGroup repeatedgroup[] = {{.a = 217}, {.a = 317}};
  message->repeatedgroup = repeatedgroup;
  const static TestAllTypes::NestedMessage repeated_nested_message[] = {{.bb = 218}, {.bb = 318}};
  message->repeated_nested_message = repeated_nested_message;

  const static protobuf_unittest::ForeignMessage<hpp::proto::non_owning_traits> repeated_foreign_message[] = {{.c = 219, .d = {}},
                                                                               {.c = 319, .d = {}}};
  message->repeated_foreign_message = repeated_foreign_message;
  const static protobuf_unittest_import::ImportMessage<hpp::proto::non_owning_traits> repeated_import_message[] = {{.d = 220}, {.d = 320}};
  message->repeated_import_message = repeated_import_message;
  const static TestAllTypes::NestedMessage repeated_lazy_message[] = {{.bb = 227}, {.bb = 327}};
  message->repeated_lazy_message = repeated_lazy_message;

  const static TestAllTypes::NestedEnum repeated_nested_enum[] = {TestAllTypes::NestedEnum::BAR,
...
inline void SetDefaultFields(TestAllTypes *message) {
  ...
  message->default_nested_enum = TestAllTypes::NestedEnum::FOO;
...
inline void SetOneofFields(TestAllTypes *message) {
  ...
  using enum TestAllTypes::oneof_field_oneof_case;
  message->oneof_field.emplace<static_cast<int>(oneof_nested_message)>(TestAllTypes::NestedMessage{.bb = 602});
...
inline void ExpectAllSet(const TestAllTypes &message) {
  ...
  expect(TestAllTypes::NestedEnum::BAZ == message.optional_nested_enum.value());
  ...
  expect(TestAllTypes::NestedEnum::BAR == message.repeated_nested_enum[0]);
  ...
  expect(TestAllTypes::NestedEnum::BAZ == message.repeated_nested_enum[1]);
  ...
  expect(TestAllTypes::NestedEnum::FOO == message.default_nested_enum.value());
  ...
  expect(message.oneof_field.index() == TestAllTypes::oneof_bytes);

  expect(std::ranges::equal("604"_bytes, std::get<TestAllTypes::oneof_bytes>(message.oneof_field)));
}
...
inline void ExpectClear(const TestAllTypes &message) {
  ...
  expect(TestAllTypes::NestedEnum::FOO == message.optional_nested_enum.value());
  ...
  expect(TestAllTypes::NestedEnum::BAR == message.default_nested_enum.value());
...
inline void SetAll(TestPackedTypes *message, auto && /*unused*/) {
...
inline void SetAll(TestUnpackedTypes *message, auto && /*unused*/) {
...
inline void SetAll(TestAllExtensions *message, auto &&mr) {
  expect(message->set_extension(protobuf_unittest::optional_int32_extension{}, 101, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_int64_extension{}, 102, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_uint32_extension{}, 103, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_uint64_extension{}, 104, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_sint32_extension{}, 105, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_sint64_extension{}, 106, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_fixed32_extension{}, 107, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_fixed64_extension{}, 108, hpp::proto::alloc_from{mr}).ok());
  expect(
      message->set_extension(protobuf_unittest::optional_sfixed32_extension{}, 109, hpp::proto::alloc_from{mr}).ok());
  expect(
      message->set_extension(protobuf_unittest::optional_sfixed64_extension{}, 110, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_float_extension{}, 111, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_double_extension{}, 112, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::optional_bool_extension{}, true, hpp::proto::alloc_from{mr}).ok());
  expect(
  ...
  expect(message->set_extension(protobuf_unittest::optionalgroup_extension{}, {.a = 117}, hpp::proto::alloc_from{mr})
             .ok());
  expect(message
             ->set_extension(protobuf_unittest::optional_nested_message_extension{}, {.bb = 118},
  ...
  expect(message
             ...
             .ok());
  expect(message
             ->set_extension(protobuf_unittest::optional_import_message_extension{}, {.d = 120},
                             hpp::proto::alloc_from{mr})
             .ok());

  expect(message
             ->set_extension(protobuf_unittest::optional_nested_enum_extension{}, TestAllTypes::NestedEnum::BAZ,
                             hpp::proto::alloc_from{mr})
             .ok());
  expect(message
             ->set_extension(protobuf_unittest::optional_foreign_enum_extension{},
                             protobuf_unittest::ForeignEnum::FOREIGN_BAZ, hpp::proto::alloc_from{mr})
             .ok());
  expect(message
             ->set_extension(protobuf_unittest::optional_import_enum_extension{},
                             protobuf_unittest_import::ImportEnum::IMPORT_BAZ, hpp::proto::alloc_from{mr})
             .ok());

  expect(message->set_extension(protobuf_unittest::optional_string_piece_extension{}, "124", hpp::proto::alloc_from{mr})
             .ok());
  expect(message->set_extension(protobuf_unittest::optional_cord_extension{}, "125", hpp::proto::alloc_from{mr}).ok());

  expect(message
             ->set_extension(protobuf_unittest::optional_public_import_message_extension{}, {.e = 126},
                             hpp::proto::alloc_from{mr})
             .ok());
  expect(
      message
          ->set_extension(protobuf_unittest::optional_lazy_message_extension{}, {.bb = 127}, hpp::proto::alloc_from{mr})
          .ok());
  ...
  expect(message
             ->set_extension(protobuf_unittest::repeated_int32_extension{}, repeated_int32_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static int64_t repeated_int64_extension[] = {202, 302};
  expect(message
             ->set_extension(protobuf_unittest::repeated_int64_extension{}, repeated_int64_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static uint32_t repeated_uint32_extension[] = {203, 303};
  expect(message
             ->set_extension(protobuf_unittest::repeated_uint32_extension{}, repeated_uint32_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static uint64_t repeated_uint64_extension[] = {204, 304};
  expect(message
             ->set_extension(protobuf_unittest::repeated_uint64_extension{}, repeated_uint64_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static int32_t repeated_sint32_extension[] = {205, 305};
  expect(message
             ->set_extension(protobuf_unittest::repeated_sint32_extension{}, repeated_sint32_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static int64_t repeated_sint64_extension[] = {206, 306};
  expect(message
             ->set_extension(protobuf_unittest::repeated_sint64_extension{}, repeated_sint64_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static uint32_t repeated_fixed32_extension[] = {207, 307};
  expect(message
             ->set_extension(protobuf_unittest::repeated_fixed32_extension{}, repeated_fixed32_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static uint64_t repeated_fixed64_extension[] = {208, 308};
  expect(message
             ->set_extension(protobuf_unittest::repeated_fixed64_extension{}, repeated_fixed64_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static int32_t repeated_sfixed32_extension[] = {209, 309};
  expect(message
             ->set_extension(protobuf_unittest::repeated_sfixed32_extension{}, repeated_sfixed32_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static int64_t repeated_sfixed64_extension[] = {210, 310};
  expect(message
             ->set_extension(protobuf_unittest::repeated_sfixed64_extension{}, repeated_sfixed64_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static float repeated_float_extension[] = {211, 311};
  expect(message
             ->set_extension(protobuf_unittest::repeated_float_extension{}, repeated_float_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static double repeated_double_extension[] = {212, 312};
  expect(message
             ->set_extension(protobuf_unittest::repeated_double_extension{}, repeated_double_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static bool repeated_bool_extension[] = {true, false};
  expect(message
             ->set_extension(protobuf_unittest::repeated_bool_extension{}, repeated_bool_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static std::string_view repeated_string_extension[] = {"215", "315"};
  expect(message
             ->set_extension(protobuf_unittest::repeated_string_extension<hpp::proto::non_owning_traits>{}, repeated_string_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static std::array repeated_bytes_extension{"216"_bytes_view, "316"_bytes_view};
  expect(message
             ->set_extension(protobuf_unittest::repeated_bytes_extension<hpp::proto::non_owning_traits>{}, repeated_bytes_extension,
                             hpp::proto::alloc_from{mr})
             .ok());

  const static protobuf_unittest::RepeatedGroup_extension<hpp::proto::non_owning_traits> repeatedgroup[] = {{.a = 217}, {.a = 317}};
  expect(message->set_extension(protobuf_unittest::repeatedgroup_extension<hpp::proto::non_owning_traits>{}, repeatedgroup, hpp::proto::alloc_from{mr})
             .ok());
  const static TestAllTypes::NestedMessage repeated_nested_message_extension[] = {{.bb = 218}, {.bb = 318}};
  expect(message
             ->set_extension(protobuf_unittest::repeated_nested_message_extension<hpp::proto::non_owning_traits>{}, repeated_nested_message_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static protobuf_unittest::ForeignMessage<hpp::proto::non_owning_traits> repeated_foreign_message_extension[] = {{.c = 219, .d = {}},
                                                                                         {.c = 319, .d = {}}};
  expect(message
             ->set_extension(protobuf_unittest::repeated_foreign_message_extension<hpp::proto::non_owning_traits>{},
                             repeated_foreign_message_extension, hpp::proto::alloc_from{mr})
             .ok());
  const static protobuf_unittest_import::ImportMessage<hpp::proto::non_owning_traits> repeated_import_message_extension[] = {{.d = 220}, {.d = 320}};
  expect(message
             ->set_extension(protobuf_unittest::repeated_import_message_extension<hpp::proto::non_owning_traits>{}, repeated_import_message_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static TestAllTypes::NestedMessage repeated_lazy_message_extension[] = {{.bb = 227}, {.bb = 327}};
  expect(message
             ->set_extension(protobuf_unittest::repeated_lazy_message_extension<hpp::proto::non_owning_traits>{}, repeated_lazy_message_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  ...
  const static TestAllTypes::NestedEnum repeated_nested_enum[] = {TestAllTypes::NestedEnum::BAR,
                                                                  TestAllTypes::NestedEnum::BAZ};
  expect(message
             ->set_extension(protobuf_unittest::repeated_nested_enum_extension{}, repeated_nested_enum,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static protobuf_unittest::ForeignEnum repeated_foreign_enum[] = {protobuf_unittest::ForeignEnum::FOREIGN_BAR,
                                                                         protobuf_unittest::ForeignEnum::FOREIGN_BAZ};
  expect(message
             ->set_extension(protobuf_unittest::repeated_foreign_enum_extension{}, repeated_foreign_enum,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static protobuf_unittest_import::ImportEnum repeated_import_enum[] = {
      protobuf_unittest_import::ImportEnum::IMPORT_BAR, protobuf_unittest_import::ImportEnum::IMPORT_BAZ};
  expect(message
             ->set_extension(protobuf_unittest::repeated_import_enum_extension{}, repeated_import_enum,
                             hpp::proto::alloc_from{mr})
             .ok());

  const static std::string_view repeated_string_piece_extension[] = {"224"sv, "324"sv};
  expect(message
             ->set_extension(protobuf_unittest::repeated_string_piece_extension<hpp::proto::non_owning_traits>{}, repeated_string_piece_extension,
                             hpp::proto::alloc_from{mr})
             .ok());
  const static std::string_view repeated_cord_extension[] = {"225"sv, "325"sv};
  expect(message
             ->set_extension(protobuf_unittest::repeated_cord_extension<hpp::proto::non_owning_traits>{}, repeated_cord_extension,
                             hpp::proto::alloc_from{mr})
             .ok());

  // -----------------------------------------------------------------

  expect(message->set_extension(protobuf_unittest::default_int32_extension{}, 401, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_int64_extension{}, 402, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_uint32_extension{}, 403, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_uint64_extension{}, 404, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_sint32_extension{}, 405, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_sint64_extension{}, 406, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_fixed32_extension{}, 407, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_fixed64_extension{}, 408, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_sfixed32_extension{}, 409, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_sfixed64_extension{}, 410, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_float_extension{}, 411, hpp::proto::alloc_from{mr}).ok());
  expect(message->set_extension(protobuf_unittest::default_double_extension{}, 412, hpp::proto::alloc_from{mr}).ok());
  ...
  expect(message
             ->set_extension(protobuf_unittest::default_nested_enum_extension{}, TestAllTypes::NestedEnum::FOO,
                             hpp::proto::alloc_from{mr})
             .ok());
  expect(message
             ->set_extension(protobuf_unittest::default_foreign_enum_extension{},
                             protobuf_unittest::ForeignEnum::FOREIGN_FOO, hpp::proto::alloc_from{mr})
             .ok());
  expect(message
             ->set_extension(protobuf_unittest::default_import_enum_extension{},
                             protobuf_unittest_import::ImportEnum::IMPORT_FOO, hpp::proto::alloc_from{mr})
             .ok());

  expect(message->set_extension(protobuf_unittest::default_string_piece_extension{}, "424", hpp::proto::alloc_from{mr})
             .ok());
  expect(message->set_extension(protobuf_unittest::default_cord_extension{}, "425", hpp::proto::alloc_from{mr}).ok());

  SetOneofFields(message, hpp::proto::alloc_from{mr});
}

inline void SetOneofFields(TestAllExtensions *message, auto &&mr) {
  expect(message->set_extension(protobuf_unittest::oneof_uint32_extension{}, 601, hpp::proto::alloc_from{mr}).ok());
  expect(
      message
          ->set_extension(protobuf_unittest::oneof_nested_message_extension{}, {.bb = 602}, hpp::proto::alloc_from{mr})
          .ok());
...
inline void ExpectAllSet(const TestAllExtensions &message) {
  ...
  expect(eq("115"sv, message
                         .get_extension(protobuf_unittest::optional_string_extension<hpp::proto::non_owning_traits>{},
                                        hpp::proto::alloc_from{mr})
                         .value()));
  expect(std::ranges::equal(
      "116"_bytes, message
                       .get_extension(protobuf_unittest::optional_bytes_extension<hpp::proto::non_owning_traits>{},
                                      hpp::proto::alloc_from{mr})
                       .value()));
  ...
  using enum TestAllTypes::NestedEnum;
  ...
  expect(
      eq("124"sv,
         message.get_extension(protobuf_unittest::optional_string_piece_extension<hpp::proto::non_owning_traits>{}, opt)
             .value()));
  expect(eq(
      "125"sv,
      message.get_extension(protobuf_unittest::optional_cord_extension<hpp::proto::non_owning_traits>{}, opt).value()));
  expect(
  ...
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_int32_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<int32_t>{201, 301}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_int64_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<int64_t>{202, 302}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_uint32_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<uint32_t>{203, 303}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_uint64_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<uint64_t>{204, 304}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_sint32_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<int32_t>{205, 305}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_sint64_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<int64_t>{206, 306}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_fixed32_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<uint32_t>{207, 307}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_fixed64_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<uint64_t>{208, 308}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_sfixed32_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<int32_t>{209, 309}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_sfixed64_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<int64_t>{210, 310}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_float_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<float>{211, 311}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_double_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<double>{212, 312}));
  expect(
      std::ranges::equal(message
                             .get_extension(protobuf_unittest::repeated_bool_extension<hpp::proto::non_owning_traits>{},
                                            hpp::proto::alloc_from{mr})
                             .value(),
                         std::initializer_list<bool>{true, false}));
  expect(std::ranges::equal(
      message
          .get_extension(protobuf_unittest::repeated_string_extension<hpp::proto::non_owning_traits>{},
                         hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<std::string_view>{"215"sv, "315"sv}));

  auto repeated_bytes = message
                            .get_extension(protobuf_unittest::repeated_bytes_extension<hpp::proto::non_owning_traits>{},
                                           hpp::proto::alloc_from{mr})
                            .value();
  ...
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeatedgroup_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<protobuf_unittest::RepeatedGroup_extension<>>{{.a = 217}, {.a = 317}},
      [](auto x, auto y) { return x.a == y.a; }));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeated_nested_message_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<TestAllTypes::NestedMessage>{{.bb = 218}, {.bb = 318}}, [](auto x, auto y) { return x.bb == y.bb; }));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeated_foreign_message_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr})
          .value(),
      std::initializer_list<protobuf_unittest::ForeignMessage<>>{{.c = 219, .d = {}}, {.c = 319, .d = {}}},
      [](auto x, auto y) { return x.c == y.c; }));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeated_import_message_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<protobuf_unittest_import::ImportMessage<>>{{.d = 220}, {.d = 320}},
      [](auto x, auto y) { return x.d == y.d; }));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeated_lazy_message_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<TestAllTypes::NestedMessage>{{.bb = 227}, {.bb = 327}}, [](auto x, auto y) { return x.bb == y.bb; }));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeated_nested_enum_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<TestAllTypes::NestedEnum>{TestAllTypes::NestedEnum::BAR, TestAllTypes::NestedEnum::BAZ}));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeated_foreign_enum_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<protobuf_unittest::ForeignEnum>{protobuf_unittest::ForeignEnum::FOREIGN_BAR,
                                                  protobuf_unittest::ForeignEnum::FOREIGN_BAZ}));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeated_import_enum_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value(),
  ...
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeated_string_piece_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<std::string_view>{"224"sv, "324"sv}));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::repeated_cord_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<std::string_view>{"225"sv, "325"sv}));
...
inline void ExpectClear(const TestAllExtensions &message) {
  ...
  expect(eq(""sv,
            message.get_extension(protobuf_unittest::optional_string_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value()));
  expect(std::ranges::equal(
      ""_bytes,
      message.get_extension(protobuf_unittest::optional_bytes_extension<hpp::proto::non_owning_traits>{}, hpp::proto::alloc_from{mr}).value()));
  ...
  auto opt = hpp::proto::alloc_from{mr};
  expect(eq(""sv, message.get_extension(protobuf_unittest::optional_string_piece_extension<hpp::proto::non_owning_traits>{}, opt).value()));
  expect(eq(""sv, message.get_extension(protobuf_unittest::optional_cord_extension<hpp::proto::non_owning_traits>{}, opt).value()));
...
inline void SetAll(TestPackedExtensions *message, auto &&mr) {
  ...
  expect(message->set_extension(protobuf_unittest::packed_int32_extension{}, packed_int32, hpp::proto::alloc_from{mr})
             .ok());
  const int64_t packed_int64[] = {602, 702};
  expect(message->set_extension(protobuf_unittest::packed_int64_extension{}, packed_int64, hpp::proto::alloc_from{mr})
             .ok());
  const uint32_t packed_uint32[] = {603, 703};
  expect(message->set_extension(protobuf_unittest::packed_uint32_extension{}, packed_uint32, hpp::proto::alloc_from{mr})
             .ok());
  const uint64_t packed_uint64[] = {604, 704};
  expect(message->set_extension(protobuf_unittest::packed_uint64_extension{}, packed_uint64, hpp::proto::alloc_from{mr})
             .ok());
  const int32_t packed_sint32[] = {605, 705};
  expect(message->set_extension(protobuf_unittest::packed_sint32_extension{}, packed_sint32, hpp::proto::alloc_from{mr})
             .ok());
  const int64_t packed_sint64[] = {606, 706};
  expect(message->set_extension(protobuf_unittest::packed_sint64_extension{}, packed_sint64, hpp::proto::alloc_from{mr})
             .ok());
  const uint32_t packed_fixed32[] = {607, 707};
  expect(
      message->set_extension(protobuf_unittest::packed_fixed32_extension{}, packed_fixed32, hpp::proto::alloc_from{mr})
          .ok());
  const uint64_t packed_fixed64[] = {608, 708};
  expect(
      message->set_extension(protobuf_unittest::packed_fixed64_extension{}, packed_fixed64, hpp::proto::alloc_from{mr})
          .ok());
  const int32_t packed_sfixed32[] = {609, 709};
  expect(
      message
          ->set_extension(protobuf_unittest::packed_sfixed32_extension{}, packed_sfixed32, hpp::proto::alloc_from{mr})
          .ok());
  const int64_t packed_sfixed64[] = {610, 710};
  expect(
      message
          ->set_extension(protobuf_unittest::packed_sfixed64_extension{}, packed_sfixed64, hpp::proto::alloc_from{mr})
          .ok());
  const float packed_float[] = {611, 711};
  expect(message->set_extension(protobuf_unittest::packed_float_extension{}, packed_float, hpp::proto::alloc_from{mr})
             .ok());
  const double packed_double[] = {612, 712};
  expect(message->set_extension(protobuf_unittest::packed_double_extension{}, packed_double, hpp::proto::alloc_from{mr})
             .ok());
  const bool packed_bool[] = {true, false};
  expect(
      message->set_extension(protobuf_unittest::packed_bool_extension{}, packed_bool, hpp::proto::alloc_from{mr}).ok());
  const protobuf_unittest::ForeignEnum packed_enum[] = {protobuf_unittest::ForeignEnum::FOREIGN_BAR,
                                                        protobuf_unittest::ForeignEnum::FOREIGN_BAZ};
  expect(
      message->set_extension(protobuf_unittest::packed_enum_extension{}, packed_enum, hpp::proto::alloc_from{mr}).ok());
}
...
inline void ExpectAllSet(const TestPackedExtensions &message) {
  ...
  expect(std::ranges::equal(
      ...
      std::initializer_list<int32_t>{601, 701}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_int64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int64_t>{602, 702}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_uint32_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<uint32_t>{603, 703}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_uint64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<uint64_t>{604, 704}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_sint32_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int32_t>{605, 705}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_sint64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int64_t>{606, 706}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_fixed32_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<uint32_t>{607, 707}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_fixed64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<uint64_t>{608, 708}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_sfixed32_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int32_t>{609, 709}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_sfixed64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int64_t>{610, 710}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_float_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<float>{611, 711}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_double_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<double>{612, 712}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_bool_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<hpp::proto::boolean>{true, false}));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::packed_enum_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<protobuf_unittest::ForeignEnum>{protobuf_unittest::ForeignEnum::FOREIGN_BAR,
                                                  protobuf_unittest::ForeignEnum::FOREIGN_BAZ}));
}
...
inline void ExpectAllSet(const TestUnpackedExtensions &message) {
  ...
  expect(std::ranges::equal(
      ...
      std::initializer_list<int32_t>{601, 701}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_int64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int64_t>{602, 702}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_uint32_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<uint32_t>{603, 703}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_uint64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<uint64_t>{604, 704}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_sint32_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int32_t>{605, 705}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_sint64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int64_t>{606, 706}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_fixed32_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<uint32_t>{607, 707}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_fixed64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<uint64_t>{608, 708}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_sfixed32_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int32_t>{609, 709}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_sfixed64_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<int64_t>{610, 710}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_float_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<float>{611, 711}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_double_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<double>{612, 712}));
  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_bool_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<hpp::proto::boolean>{true, false}));

  expect(std::ranges::equal(
      message.get_extension(protobuf_unittest::unpacked_enum_extension{}, hpp::proto::alloc_from{mr}).value(),
      std::initializer_list<protobuf_unittest::ForeignEnum>{protobuf_unittest::ForeignEnum::FOREIGN_BAR,
                                                  protobuf_unittest::ForeignEnum::FOREIGN_BAZ}));
}
...
inline void ExpectOneofSet1(const TestOneof2 &message) {
  ...
  expect(eq("101"sv, std::get<TestOneof2::bar_string>(message.bar)));
...
inline void ExpectOneofSet2(const TestOneof2 &message) {
  ...
  expect(TestOneof2::NestedEnum::BAZ ==
         std::get<TestOneof2::bar_enum>(message.bar));
...
const boost::ut::suite proto_test = [] {
  ...
  "protobuf"_test =
      ...
      std::tuple<TestAllTypes, TestAllExtensions, TestUnpackedTypes,
                 TestPackedTypes, TestPackedExtensions>{};
  ...
  } | std::tuple<TestAllTypes, TestUnpackedTypes, TestPackedTypes>{};
#endif
};
