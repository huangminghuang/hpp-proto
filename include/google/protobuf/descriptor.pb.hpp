...
auto pb_meta(const ExtensionRangeOptions &) -> std::tuple<
  ...
  hpp::proto::field_meta<2, &ExtensionRangeOptions::declaration, hpp::proto::field_option::unpacked_repeated>,
...
auto pb_meta(const FieldOptions &) -> std::tuple<
  ...
  hpp::proto::field_meta<17, &FieldOptions::retention, hpp::proto::field_option::none, void, ::google::protobuf::FieldOptions::OptionRetention::RETENTION_UNKNOWN>,
