...
function(protobuf_generate)
  ...
  if (protobuf_generate_LANGUAGE STREQUAL hpp)
    set(protobuf_generate_PLUGIN "protoc-gen-hpp=\$<TARGET_FILE:hpp_proto::protoc-gen-hpp>")
    set(protobuf_generate_DEPENDENCIES ${protobuf_generate_DEPENDENCIES} hpp_proto::protoc-gen-hpp)
    get_target_property(_target_type ${protobuf_generate_TARGET} TYPE)
  ...
  if(NOT protobuf_generate_GENERATE_EXTENSIONS)
    ...
    elseif(protobuf_generate_LANGUAGE STREQUAL hpp)
      set(protobuf_generate_GENERATE_EXTENSIONS .msg.hpp .pb.hpp .glz.hpp)
    else()
  ...
  foreach(_proto ${protobuf_generate_PROTOS})
    ...
    add_custom_command(
      ...
      DEPENDS ${_abs_file} hpp_proto::protoc ${protobuf_generate_DEPENDENCIES}
      COMMENT ${_comment}
      VERBATIM )
  endforeach()
